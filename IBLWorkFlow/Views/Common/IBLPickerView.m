...
NSString * const CMCCbackgroundColor = @"backgroundColor";
NSString * const CMCCtextColor = @"textColor";
NSString * const CMCCtoolbarColor = @"toolbarColor";
NSString * const CMCCbuttonColor = @"buttonColor";
NSString * const CMCCfont = @"font";
NSString * const CMCCvalueY = @"yValueFromTop";
NSString * const CMCCselectedObject = @"selectedObject";
NSString * const CMCCtoolbarBackgroundImage = @"toolbarBackgroundImage";

@interface IBLPickerView () <UIPickerViewDelegate, UIPickerViewDataSource>
...
@implementation IBLPickerView

#pragma mark - Singleton

+ (IBLPickerView *)sharedView {
  static dispatch_once_t once;
  static IBLPickerView *sharedView;
...
-(void)dismiss{
 [IBLPickerView dismissWithCompletion:self.onDismissCompletion];
}
...
-(void)setPickerHidden: (BOOL)hidden
  ...
  [UIView animateWithDuration:0.3
                   ...
                   animations:^{
                     ...
                     if(completed && hidden){
                       [IBLPickerView removePickerView];
...
-(void)initializePickerViewInView: (UIView *)view
  ...
  id chosenObject = options[CMCCselectedObject];
  ...
  UIColor *pickerViewBackgroundColor = [[UIColor alloc] initWithCGColor:[options[CMCCbackgroundColor] CGColor]];
  UIColor *pickerViewTextColor = [[UIColor alloc] initWithCGColor:[options[CMCCtextColor] CGColor]];
  UIColor *toolbarBackgroundColor = [[UIColor alloc] initWithCGColor:[options[CMCCtoolbarColor] CGColor]];
  UIColor *buttonTextColor = [[UIColor alloc] initWithCGColor:[options[CMCCbuttonColor] CGColor]];
  UIFont *pickerViewFont = options[CMCCfont];
  _yValueFromTop = [options[CMCCvalueY] floatValue];
    
  [self setFrame: view.bounds];
  [self setBackgroundColor:[UIColor clearColor]];
  
  UIImage * toolbarImage = options[CMCCtoolbarBackgroundImage];
  ...
  //Add pickerView
  _pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0.0, 44.0, width, 216.0)];
